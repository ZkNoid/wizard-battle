...
export class GameCommitController {
  ...
  // Resources / Coins / Items
  @Post('inventory/sync')
  syncAll(@Body() body: any) {
    return this.gameCommitService.commitIinventory(body);
  }
  ...
  // url -X POST http://localhost:3030/game-commit/inventory/sync -H "Content-Type: application/json" -d '{"userId":"B62qncsQudgoB7PuNtU9DgGaA4cCGjZF6ukJ37Wx6DamMGpYpJ9o8H2"}'
}
