...
const LOCATIONS = [
  ...
  },
  {
    ...
    possibleRewards: [
      { itemId: 'PurpleCrystall', amount: 1 },
      { itemId: 'BlueGem', amount: 1 },
      { itemId: 'RedGem', amount: 1 },
      { itemId: 'RedMaterial', amount: 1 },
      { itemId: 'MysticalPowder', amount: 1 },
      { itemId: 'OrbOfFire', amount: 1 },
      { itemId: 'RedOrb', amount: 1 },
      { itemId: 'ShadowPearl', amount: 1 },
    ],
    minRewards: 3,
    maxRewards: 5,
  },
  {
    ...
    possibleRewards: [
      { itemId: 'SpellboundLeather', amount: 1 },
      { itemId: 'StarmetalOre', amount: 1 },
      { itemId: 'VoidShard', amount: 1 },
      { itemId: 'ManaBark', amount: 1 },
      { itemId: 'MysticalPowder', amount: 1 },
      { itemId: 'Frostdust', amount: 1 },
      { itemId: 'Amber', amount: 1 },
