export const BtnXxlBg = ({ className }: { className: string }) => {
  return (
    <svg
      width="574"
      height="64"
    ...
    >
      ...
      <path d="M554 5H30V10H554V5Z" fill="#D5D8DD" />
      <path d="M559 5H554V10H559V5Z" fill="white" />
      <path d="M564 5H559V10H564V5Z" fill="#D5D8DD" />
      ...
      <path d="M564 10H15V54H564V10Z" fill="#ACB0BC" />
      <path d="M569 10H564V54H569V10Z" fill="#747C8F" />
      ...
      <path d="M564 54H10V59H564V54Z" fill="#747C8F" />
