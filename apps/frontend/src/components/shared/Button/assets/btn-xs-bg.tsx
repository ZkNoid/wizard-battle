export const BtnXsBg = ({ className }: { className: string }) => {
  return (
    <svg
      width="114"
      height="49"
    ...
    >
      ...
      <path d="M104 5H30V10H104V5Z" fill="#D5D8DD" />
      <path d="M99 5H94V10H99V5Z" fill="white" />
      <path d="M104 5H99V10H104V5Z" fill="#D5D8DD" />
      <path d="M109 5H104V10H109V5Z" fill="#070C19" />
      <path d="M5 10H0V39H5V10Z" fill="#070C19" />
      <path d="M10 10H5V39H10V10Z" fill="#747C8F" />
      <path d="M15 10H10V15H15V10Z" fill="white" />
      <path d="M104 10H15V39H104V10Z" fill="#ACB0BC" />
      <path d="M109 10H104V39H109V10Z" fill="#747C8F" />
      <path d="M114 10H109V39H114V10Z" fill="#070C19" />
      <path d="M15 15H10V25H15V15Z" fill="#D5D8DD" />
      <path d="M15 25H10V39H15V25Z" fill="#ACB0BC" />
      <path d="M10 39H5V44H10V39Z" fill="#070C19" />
      <path d="M104 39H10V44H104V39Z" fill="#747C8F" />
