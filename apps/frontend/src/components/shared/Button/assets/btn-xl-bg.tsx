export const BtnXlBg = ({ className }: { className: string }) => {
  return (
    <svg
      width="425"
      height="64"
    ...
    >
      ...
      <path d="M405 5H30V10H405V5Z" fill="#D5D8DD" />
      <path d="M410 5H405V10H410V5Z" fill="white" />
      <path d="M415 5H410V10H415V5Z" fill="#D5D8DD" />
      ...
      <path d="M415 10H15V54H415V10Z" fill="#ACB0BC" />
      <path d="M420 10H415V54H420V10Z" fill="#747C8F" />
      ...
      <path d="M415 54H10V59H415V54Z" fill="#747C8F" />
