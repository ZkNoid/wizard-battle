...
// It inherits from WBCharacters and exposes _increaseBalance for testing
contract WBCharactersTestHelper is WBCharacters {
    ...
    function exposeIncreaseBalance(address account, uint128 value) external {
        ...
        // which will call WBCharacterss's _increaseBalance override
